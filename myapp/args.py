...
parser.add_argument('--voice_dir', default='voice/', type=str)
...
parser.add_argument('--audio_input_prediction', default=['noisy_voice_long_t3.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_t3.wav', type=str)
